# Generated by Django 3.1.7 on 2021-09-20 09:22
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('proctorship', '0005_proctorship_activity_id'),
        ('feedback', '0002_auto_20210910_1209'),
    ]

    operations = [
        migrations.CreateModel(
            name='ProctorshipCertificateForm',
            fields=[
                ...
                ('proctorship', models.ForeignKey(db_column='ProctorshipID', default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='certificate_form_proctorship', to='proctorship.proctorship')),
            ],
            options={
