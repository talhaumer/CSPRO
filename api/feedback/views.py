...
from api.feedback.serializers import (
    CertificateFormSerailizers,
    CertificateFormUpdateSerailizers,
    MemoProctorFeedbackSerializer,
    MemoProctorUpdateFeedbackSerializer,
    PercevelDriverDataSerializer,
    ProctorFeedbackSerializer,
    RatingDataSerializer,
    ReasonDataSerializer,
    SoloSmartProctorFeedbackSerializer,
    SoloSmartUpdateFeedbackSerializer,
    TraineeFeedbackSerializer,
    TraineeMemoFeedbackSerializer,
    TraineeMemoUpdateFeedbackSerializer,
    TraineeUpdateFeedbackSerializer,
)
...
class ProctorFeedbackView(BaseAPIView):
    ...
    def get(self, request, pk=None):
        try:
            ...
            if activity_id:
                product = ProctorshipProctorFeedback.objects.filter(
            ...
            return self.send_response(
                code="",
                status_code=status.HTTP_422_UNPROCESSABLE_ENTITY,
                description="Proctor Feedback doesn't exists",
            )
        except FieldError:
            return self.send_response(
                code=f"500",
    ...
    def put(self, request, pk=None):
        try:
            ...
            data = request.data
            serializer = ProctorFeedbackSerializer(
...
class TraineeFeedbackView(BaseAPIView):
    ...
    def get(self, request, pk=None):
        try:
            ...
            products = TraineeFeedback.objects.filter(
                trainee__proctorship__id=activity_id
            )
    ...
    def post(self, request):
        try:
            ...
            if serializer.is_valid():
                product_saved = serializer.save()
                proctorship(
                    Proctorship.objects.get(trainee_proctorship__id=data["trainee_id"])
                )
    ...
    def put(self, request, pk=None):
        try:
            ...
            data = request.data
            serializer = TraineeUpdateFeedbackSerializer(
                instance=saved_product, data=data, partial=True
            )
            if serializer.is_valid():
                product_saved = serializer.save()
...
class MemoProctorFeedBackView(BaseAPIView):
    ...
    def get(self, request, pk=None):
        try:
            ...
            if activity_id:
                trainee = MemoProctorFeedBack.objects.filter(
                    proctorship__id=activity_id
                )
                serializer = MemoProctorFeedbackSerializer(trainee, many=True)
                return self.send_response(
            ...
            return self.send_response(
                code="422",
                status_code=status.HTTP_422_UNPROCESSABLE_ENTITY,
                description="No Memo Feedback matches the given query.",
            )
        except MemoProctorFeedBack.DoesNotExist:
            return self.send_response(
                code="",
                status_code=status.HTTP_422_UNPROCESSABLE_ENTITY,
                description="Memo Feedback doesn't exists",
            )
        except FieldError:
            return self.send_response(
                code=f"500",
    ...
    def put(self, request, pk=None):
        try:
            ...
            data = request.data
            serializer = MemoProctorUpdateFeedbackSerializer(
                instance=saved_product, data=data
            )
            if serializer.is_valid():
                product_saved = serializer.save()
                return self.send_response(
                    ...
                    code=f"201",
                    status_code=status.HTTP_201_CREATED,
                    description="Memo Feedback is updated",
                )
            return self.send_response(
                code=f"422",
                status_code=status.HTTP_422_UNPROCESSABLE_ENTITY,
    ...
    def get(self, request, pk=None):
        try:
            ...
            return self.send_response(
                code=f"422",
                status_code=status.HTTP_422_UNPROCESSABLE_ENTITY,
                description="Percevel Driver doesn't exists",
            )
        except FieldError:
            return self.send_response(
                code=f"500",
    ...
    def get(self, request, pk=None):
        try:
            ...
            return self.send_response(
                code=f"422",
                status_code=status.HTTP_422_UNPROCESSABLE_ENTITY,
                description="Reason doesn't exists",
            )
        except FieldError:
            return self.send_response(
                code=f"500",
...
class SoloSmartProctorFeedBackView(BaseAPIView):
    ...
    def get(self, request, pk=None):
        try:
            ...
            if activity_id:
                trainee = SoloSmartProctorFeedBack.objects.filter(
                    proctorship__id=activity_id
                )
                serializer = SoloSmartProctorFeedbackSerializer(trainee, many=True)
                return self.send_response(
    ...
    def put(self, request, pk=None):
        try:
            ...
            data = request.data
            serializer = SoloSmartUpdateFeedbackSerializer(
                instance=saved_product, data=data, partial=True
            )
            if serializer.is_valid():
                product_saved = serializer.save()
...
class CertificateFormView(BaseAPIView):
    ...
    def get(self, request, pk=None):
        try:
            activity_id = request.query_params.get("activity_id", "")
            if pk is not None:
                proctorship_attendance = ProctorshipCertificateForm.objects.filter(
                    proctorship__id=pk
                )
                serializer = CertificateFormSerailizers(
    ...
    def put(self, request, pk: None):
        try:
            data = request.data
            proctorship_attendance = ProctorshipCertificateForm.objects.get(
                proctorship__id=pk
            )
            serializer = CertificateFormUpdateSerailizers(
