...
from api.zone.serializers import CountriesSerializer, ZoneSerializer
...
class HospitalUpdateSerializer(serializers.ModelSerializer):
    ...
    def update(self, instance, validated_data):
        ...
        instance.number_of_trainee = validated_data.get(
            "number_of_trainee", instance.number_of_trainee
        )
        ...
        instance.is_it_preceptorship = validated_data.get(
            "is_it_preceptorship", instance.is_it_preceptorship
        )
        instance.qualified_for_news_mics_program = validated_data.get(
            "qualified_for_news_mics_program", instance.qualified_for_news_mics_program
        )
