...
class Hospital(Base):
    hospital_name = models.CharField(
        max_length=255, db_column="HospitalName", blank=True, null=True
    )
    ...
    is_it_preceptorship = models.BooleanField(
        default=False, db_column="IsItPreceptorship"
    )
    qualified_for_news_mics_program = models.BooleanField(
        default=False, db_column="QualifiedForNewsMicsProgram"
    )
    cognos_id = models.CharField(
        default="", db_column="CognosID", max_length=255, blank=True, null=True
    )
