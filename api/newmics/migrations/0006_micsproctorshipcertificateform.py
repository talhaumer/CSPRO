    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('certificate', models.FileField(blank=True, db_column='Certificate', default=None, null=True, upload_to='uploads/')),
                ('mics_perceptership', models.ForeignKey(db_column='MicsPerceptershipID', default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='mics_certificate_form_mics_perceptership', to='newmics.micspreceptorship')),
                ('mics_proctorship', models.ForeignKey(db_column='MicsProctorshipID', default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='mics_certificate_form_mics_proctorship', to='newmics.micsproctorship')),
            ],
            options={
