...
from api.masterproctorship.serializers import (
    AttendanceFormMasterProctorShipSerailizers,
    AttendanceFormMasterProctorShipUpdateSerailizers,
    InvoiceMasterProctorshipSerializer,
    InvoiceMasterProctorShipUpdateSerializer,
    MasterProctorShipConstantDataSerializers,
    MasterProctorshipFeedbackSerializers,
    MasterProctorshipListingSerializer,
    MasterProctorshipProctorReportSerializers,
    MasterProctorshipProctorUpdateReportSerializers,
    MasterProctorshipSerializer,
    MasterProctorshipStatusSerializer,
    MasterProctorshipStatusTestingSerializer,
    MasterProctorshipStatusViewSerializer,
    MasterProctorshipUpdateFeedbackSerializers,
    MasterProctorshipViewSerializer,
    MProposalDateUpdateSerializer,
    TraineeMasterProctorshipSerializer,
    TraineeMasterUpdateProctorshipSerializer,
)
...
class MasterProctorshipView(BaseAPIView):
    ...
    def put(self, request, pk=None):
        try:
            ...
            data = request.data
            serializer = MasterProctorshipSerializer(
                instance=saved_masterproctorship, data=data, partial=True
            )
            if serializer.is_valid():
                serializer.save()
                return self.send_response(
...
class MasterProctorshipConstantDataView(BaseAPIView):
    ...
    def get(self, request, pk=None):
        try:
            ...
            serializer = MasterProctorShipConstantDataSerializers(
                masterproctorship, many=True
            )
            return self.send_response(
                success=True,
                status_code=status.HTTP_200_OK,
        ...
        try:
            ...
            if activity_id:
                activity_status = MasterProctorshipStatus.objects.filter(
                    master_proctorship_activity__id=activity_id
                ).order_by("timestamp")
                serializer = MasterProctorshipStatusViewSerializer(
            ...
            return self.send_response(
                ...
                payload=[],
                code="422",
                description="Enter Valid MasterProctorshipId",
            )
        ...
        try:
            ...
            start_date = str(
                MasterProctorshipProposal.objects.filter(
                    status__master_proctorship_activity__id=data[
            ...
            if data["status"] == "confirmed":
                proctors = (
                    ...
                    .filter(alter_master_proctorship_porposal__isnull=False)
                    .latest("created_on")
                    .alter_master_proctorship_porposal.filter(
                        master_proctorship_porposal__isnull=False
                    )
                    .latest("created_on")
                    .master_proctorship_porposal.all()
                )
                        ...
                        if not check_perceptorship(
                            ...
                            if not check_masterproctorship(
                                ...
                                if not check_event(
                                    ...
                                    each.status = True
                                    each.save()
                                    serializer = MasterProctorshipStatusSerializer(
                                        data=data
                                    )
                                    if serializer.is_valid():
    ...
    def get(self, request, pk=None):
        try:
            if pk is not None:
                ...
                trainee.save()
                return self.send_response(
                    description="MasterProctorship Trainee Profile is is revoked successfuly",
                    success=True,
                    status_code=status.HTTP_200_OK,
                    code="200",
                )
    ...
    def get(self, request, pk=None):
        try:
            ...
            if master_proctorship_id:
                trainees = MasterProctorshipTraineeProfile.objects.filter(
                    master_proctorship__id=master_proctorship_id
                )
            ...
            return self.send_response(
                ...
                payload=[],
                code="422",
                description="Enter valid MasterProctorship Id",
                log_description="",
            )
        except ObjectDoesNotExist:
            return self.send_response(
...
class MasterProctorshipTraineeProfileAddView(BaseAPIView):
    ...
    def put(self, request, pk=None):
        try:
            ...
            serializer = TraineeMasterUpdateProctorshipSerializer(
...
class MasterProctorshipAddReportView(BaseAPIView):
    ...
    def get(self, request, pk=None):
        try:
            if pk:
                ...
                serializer = MasterProctorshipProctorReportSerializers(
                    activity_status, many=True
                )
                return self.send_response(
                    success=True,
    ...
    def post(self, request):
        try:
            ...
            master_proctorship_id = MasterProctorship.objects.get(
                trainee_master_proctorship__id=data["master_proctorship_trainee_id"]
            )
            if serializer.is_valid():
                saved_status = serializer.save()
    ...
    def put(self, request, pk=None):
        try:
            data = request.data
            saved_report = MasterProctorshipProctorReport.objects.get(
                master_proctorship_trainee__id=pk
            )
            serializer = MasterProctorshipProctorUpdateReportSerializers(
...
class MasterProctorshipFeedbackView(BaseAPIView):
    ...
    def get(self, request, pk=None):
        try:
            activity_id = request.query_params.get("activity_id", "")
            if pk:
                activity_status = MasterProctorshipFeedback.objects.filter(
                    master_proctorship_activity__id=pk
                )
                serializer = MasterProctorshipFeedbackSerializers(
                    activity_status, many=True
                )
                return self.send_response(
                    success=True,
            ...
            return self.send_response(
                ...
                payload=[],
                code="422",
                description="Enter Valid MasterProctorship Feedback",
            )
        except IntegrityError as i:
            return self.send_response(
                code=f"422",
    ...
    def post(self, request):
        try:
            ...
            if serializer.is_valid():
                saved_status = serializer.save()
                master_proctorship(
                    MasterProctorship.objects.get(
                        id=data["master_proctorship_activity_id"]
                    )
                )
                return self.send_response(
                    success=True,
    ...
    def put(self, request, pk=None):
        try:
            data = request.data
            saved_report = MasterProctorshipFeedback.objects.get(
                master_proctorship_activity__id=pk
            )
            serializer = MasterProctorshipUpdateFeedbackSerializers(
                instance=saved_report, data=data
            )
            if serializer.is_valid():
                saved_status = serializer.save()
...
class MDateUpdateView(BaseAPIView):
    ...
    def put(self, request, pk=None):
        try:
            ...
            serializer = MProposalDateUpdateSerializer(
...
class MasterProctorshipListingApiView(BaseAPIView, CustomPagination):
    ...
    def get(self, request, pk=None):
        try:
            ...
            if search_value:
                master_proctorship = master_proctorship.filter(
                    ...
                    | Q(
                        master_proctorship_status__alter_master_proctorship_porposal__master_proctorship_porposal__proctors__user__name__icontains=search_value
                    )
                ).distinct()
            ...
            if actvity_status:
                query_object &= Q(
                    master_proctorship_status__status__code=actvity_status
                )
            ...
            master_proctorship = (
                master_proctorship.filter(query_object)
                .order_by(self.sorting_data(column_name, order))
                .distinct()
            )

            serializer = MasterProctorshipListingSerializer(
                master_proctorship[offset : offset + limit], many=True
            )
            return self.send_response(
                success=True,
                status_code=status.HTTP_200_OK,
                payload=serializer.data,
                code="200",
                description="MasterProctorship Details",
                log_description="",
...
class InvoiceMasterProctorshipView(BaseAPIView):
    ...
    def get(self, request, pk=None):
        try:
            ...
            if pk is not None:
                proctorship_invoice = InvoiceMasterProctorShip.objects.filter(
                    master_proctorship__id=pk
                )
                serializer = InvoiceMasterProctorshipSerializer(
            ...
            serializer = InvoiceMasterProctorshipSerializer(
                proctorship_invoices, many=True
            )
            return self.send_response(
                success=True,
                status_code=status.HTTP_200_OK,
    ...
    def post(self, request):
        try:
            ...
            if serializer.is_valid():
                serializer.save()
                master_proctorship(
                    MasterProctorship.objects.get(id=data["master_proctorship_id"])
                )
    ...
    def put(self, request, pk: None):
        try:
            data = request.data
            proctorship_attendance = InvoiceMasterProctorShip.objects.get(
                master_proctorship__id=pk
            )
            serializer = InvoiceMasterProctorShipUpdateSerializer(
...
class AttendanceFormMasterProctorshipView(BaseAPIView):
    ...
    def get(self, request, pk=None):
        try:
            ...
            if pk is not None:
                ...
                serializer = AttendanceFormMasterProctorShipSerailizers(
    ...
    def put(self, request, pk: None):
        try:
            data = request.data
            proctorship_attendance = AttendanceFormMasterProctorShip.objects.get(
                master_proctorship__id=pk
            )
            serializer = AttendanceFormMasterProctorShipUpdateSerailizers(
                instance=proctorship_attendance, data=data
            )
            if serializer.is_valid():
