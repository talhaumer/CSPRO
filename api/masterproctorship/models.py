...
class MasterProctorship(Base):
    ...
    master_proctorship_type = models.ForeignKey(
    ...
    transplant_time = models.CharField(
        db_column="TransplantTime", max_length=255, default=""
    )
...
class MasterProctorshipTraineeProfile(Base):
    master_proctorship = models.ForeignKey(
        MasterProctorship,
        null=True,
        blank=True,
        on_delete=models.CASCADE,
    ...
    hospital = models.ForeignKey(
        Hospital,
        db_column="MasterProctorshipTraineeHospitalID",
        null=True,
        blank=True,
        on_delete=models.CASCADE,
        related_name="masterproctorship_trainee_hospital",
    )
    title = models.ForeignKey(
        ConstantData,
        default=None,
        related_name="master_proctorship_title_constantdata",
        null=True,
        blank=True,
        db_column="Title",
        on_delete=models.CASCADE,
...
class MasterProctorshipStatus(Base):
    ...
    status = models.ForeignKey(
        StatusConstantData,
        related_name="master_proctorship_status_data",
        db_column="Status",
        default=None,
        null=True,
        on_delete=models.CASCADE,
    )
    master_proctorship_activity = models.ForeignKey(
        MasterProctorship,
        db_column="MasterProctorshipStatusId",
        related_name="master_proctorship_status",
        default=None,
        null=True,
        blank=True,
        on_delete=models.CASCADE,
...
class MasterProctorshipProctors(Base):
    master_proctorship_proposal = models.ForeignKey(
    ...
    status = models.BooleanField(
        default=True, db_column="MasterProctorshipProposalStatus"
    )
    note_related_to_proctor = models.TextField(
        db_column="NoteRelatedToProctor", default=""
    )
...
class MasterProctorshipFeedback(Base):
    ...
    rate_of_proceduresc = models.CharField(
    ...
    rate_proctoring_experince = models.ForeignKey(
        Rating,
    ...
    rate_of_level_support = models.ForeignKey(
        Rating,
    ...
    new_proctor_need_further_training = models.BooleanField(
        db_column="NewProctorNeedFurtherTraining", default=False
    )
    suggestion = models.CharField(
        db_column="Suggestions", max_length=255, default="", null=True, blank=True
    )
...
class MasterProctorshipProctorReport(Base):
    master_proctorship_trainee = models.ForeignKey(
    ...
    num_of_perceval = models.IntegerField(
        db_column="NumberOfPercvelImplant", null=True, default=None
    )
    ...
    have_difficulties = models.BooleanField(
        db_column="HaveyoufeelanyDifficulty", default=False
    )
    need_for_further_training = models.BooleanField(
