    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deleted_on', models.DateTimeField(auto_now=True, db_column='DeletedOn')),
                ('status', models.BigIntegerField(db_column='Status', default=0, help_text='Be default 0 which has no meaning this field is used for making the status like pending approved and for some other purpose')),
                ('reason', models.CharField(db_column='Reason', default='', max_length=255)),
                ...
                ('transplant_time', models.CharField(db_column='TransplantTime', default='', max_length=255)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rate_of_proceduresc', models.CharField(blank=True, db_column='RateOfProceduralStep', default='', max_length=255, null=True)),
                ('new_proctor_need_further_training', models.BooleanField(db_column='NewProctorNeedFurtherTraining', default=False)),
                ('suggestion', models.CharField(blank=True, db_column='Suggestions', default='', max_length=255, null=True)),
                ('report', models.FileField(blank=True, db_column='FeedbackReport', default=None, null=True, upload_to='uploads/')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('num_of_perceval', models.IntegerField(db_column='NumberOfPercvelImplant', default=None, null=True)),
                ...
                ('proctor_report', models.FileField(blank=True, db_column='ProctorReport', default=None, null=True, upload_to='uploads/')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deleted_by', models.BigIntegerField(blank=True, db_column='DeletedBy', default=0, null=True)),
                ('deleted_on', models.DateTimeField(auto_now=True, db_column='DeletedOn')),
                ('status', models.BooleanField(db_column='MasterProctorshipProposalStatus', default=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.ForeignKey(blank=True, db_column='CountriesTraineeProfileID', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='traineeprofile_master_proctorship_country', to='zone.countries')),
            ],
            options={
