    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "type",
                    models.CharField(db_column="Type", default="", max_length=255),
                ),
                (
                    "field",
                    models.CharField(db_column="Field", default="", max_length=255),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "memo_surgeon_implant",
                    models.IntegerField(
                        blank=True, db_column="MemoSurgeonImplant", default=None
                    ),
                ),
                (
                    "rechord_surgeon_implant",
                    models.IntegerField(
                        blank=True, db_column="ReChordSurgeonImplant", default=None
                    ),
                ),
                (
                    "other_num_of_implants",
                    models.IntegerField(
                        blank=True, db_column="NumberOfPercevel", null=True
                    ),
                ),
                (
                    "ETQ_number",
                    models.IntegerField(
                        blank=True, db_column="ETQNumber", default=None, null=True
                    ),
                ),
                (
                    "issue",
                ...
                (
                    "field_check",
                    models.CharField(
                        db_column="FieldForDataCheck", default="", max_length=255
                    ),
                ),
                ("is_global", models.BooleanField(db_column="IsGlobal", default=False)),
                (
                    "note_related_to_proctor",
                    models.TextField(db_column="NoteRelatedToProctors", default=None),
                ),
                (
                    "country",
                    models.ForeignKey(
