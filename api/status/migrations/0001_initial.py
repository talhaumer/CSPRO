    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('proctorship_activity', models.ForeignKey(blank=True, db_column='ProctorShipId', default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='proctorship_status', to='proctorship.proctorship')),
                ('status', models.ForeignKey(db_column='Status', default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='status_data', to='status.statusconstantdata')),
            ],
            options={
                'db_table': 'Status',
            },
