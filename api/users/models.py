...
class Role(Base):
	...
	access_level = models.IntegerField(db_column='AccessLevel', choices=AccessLevel.CHOICES, default=AccessLevel.SALES_MANAGER)
...
class User(AbstractBaseUser, Base, PermissionsMixin):
	...
	country = models.ForeignKey(Countries,  db_column='UserCountryId', related_name= "user_country", null = True, on_delete = models.CASCADE, default = None)
...
class UserInfo(Base):
	user = models.ForeignKey(User, db_column='UserId', related_name='admin_user', default = None, on_delete=models.CASCADE)
	zone = models.ForeignKey(Zone,  db_column='UserZoneId', related_name= "user_zone", null=True, on_delete = models.CASCADE, default = None)
	MAIL_NOTIFICATION = (
		(False, 'No'),
		(True, 'Yes'),
	)
	mail_notification = models.BooleanField(db_column = 'MailNotification', null = True, blank = True, default=False)
...
class EmailToken(Base):
	user = models.ForeignKey(User, db_column='UserId', related_name='email_token_user', default = None, on_delete=models.CASCADE)
	token = models.CharField(max_length = 255, db_column = 'Token', null = True, blank = True, default = "")
