...
from api.users.views import (
    AddUserView,
    BlockedUnBlockedUsersView,
    ChangePasswordView,
    DeleteUsersView,
    ForgotPasswordView,
    GetUserView,
    LocalAdminListingView,
    LoginView,
    PasswordView,
    SalesManagerListingView,
    SuperAdminListingView,
    UpdateProfile,
    UpdateUserFormView,
    UserLogoutView,
    UserPaginationView,
...
urlpatterns = [
    ...
    path(
        "local-admin-listing",
        LocalAdminListingView.as_view(),
        name="local-admin-listing",
    ),
    path(
        "super-admin-listing",
        SuperAdminListingView.as_view(),
        name="super-admin-listing",
    ),
    path(
        "sales-manager-listing",
        SalesManagerListingView.as_view(),
        name="sales-manager-listing",
    ),
    path(
        "blocked-unblocked-user/<int:pk>",
        BlockedUnBlockedUsersView.as_view(),
        name="blocked-unblocked-user",
    ),
    path("update-user-form", UpdateUserFormView.as_view(), name="updata-user-form"),
    path(
        "update-user-form/<int:pk>",
        UpdateUserFormView.as_view(),
        name="updata-user-form",
    ),
