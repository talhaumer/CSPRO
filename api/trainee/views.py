...
from api.trainee.serializers import (
    TraineeUpdateSerializer,
    TrainProctorshipSerializer,
    TrainSerializer,
)
    ...
    def get(self, request, pk=None):
        try:
            ...
            return self.send_response(
                ...
                description="No Trainee Profile matches the given query.",
            )
...
class UpdateTraineeView(BaseAPIView):
    ...
    def put(self, request, pk=None):
        try:
            ...
            data = request.data
            serializer = TraineeUpdateSerializer(
                instance=saved_trainee, data=data, partial=True
            )
            if serializer.is_valid():
                ...
                return self.send_response(
                    ...
                    code=f"201",
                    status_code=status.HTTP_201_CREATED,
                    description="Trainee Profile is updated",
                )
            return self.send_response(
                code=f"422",
                status_code=status.HTTP_422_UNPROCESSABLE_ENTITY,
        ...
        try:
            ...
            if proctorship_id:
                trainees = TraineeProfile.objects.filter(
                    proctorship__id=proctorship_id,
                )
            ...
            return self.send_response(
                ...
                payload=[],
                code="422",
                description="Enter valid Proctorship Id",
                log_description="",
            )
        except ObjectDoesNotExist:
            return self.send_response(
