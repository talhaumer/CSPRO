...
class TraineeProfile(Base):
    proctorship = models.ForeignKey(
        ...
        related_name="trainee_proctorship",
        db_column="TraineeProctorship",
        default=None,
    )
    hospital = models.ForeignKey(
        ...
        blank=True,
        on_delete=models.CASCADE,
        related_name="traineeprofile_hospital",
    )
    country = models.ForeignKey(
        ...
        blank=True,
        on_delete=models.CASCADE,
        related_name="traineeprofile_country",
    )
    title = models.ForeignKey(
        ConstantData,
        default=None,
        related_name="title_constantdata",
        null=True,
        blank=True,
        db_column="Title",
        on_delete=models.CASCADE,
    ...
    current_preferential = models.ForeignKey(
        ...
        default=None,
        related_name="current_preferential_constantdata",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
