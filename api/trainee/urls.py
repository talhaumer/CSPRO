...
from api.trainee.views import (
    ApproveTraineeView,
    RevokeTraineeView,
    TraineeProctorshipView,
    TraineeProfileView,
    UpdateTraineeView,
)
...
urlpatterns = [
    ...
    path(
        "active-trainee/<int:pk>", ApproveTraineeView.as_view(), name="active-trainee"
    ),
    path("revoke-trainee/<int:pk>", RevokeTraineeView.as_view(), name="revoke-trainee"),
    path(
        "proctorship-trainee",
        TraineeProctorshipView.as_view(),
        name="proctorship-trainee",
    ),
]
