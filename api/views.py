...
from api.serializers import (
    ApproachSerializer,
    AreaOfExpertiesSerializer,
    AudienceSerializer,
    EventSerializer,
    HcpRoleSerializer,
    HospitalNameSerializer,
    HospitalSerializer,
    ...
    def get(self, request, pk=None):
        try:
            ...
            return self.send_response(
                ...
                description="No Products matches the given query.",
            )
...
class HospitalUpdateView(BaseAPIView):
    ...
    def put(self, request, pk=None):
        try:
            ...
            data = request.data
            serializer = HospitalUpdateSerializer(
                instance=saved_hospital, data=data, partial=True
            )
            if serializer.is_valid():
                ...
                return self.send_response(
                    ...
                    code=f"201",
                    status_code=status.HTTP_201_CREATED,
                    description="Hospital is updated",
                )
            return self.send_response(
                code=f"422",
                status_code=status.HTTP_422_UNPROCESSABLE_ENTITY,
    ...
    def get(self, request, pk=None):
        try:
            if pk is not None:
                ...
                print(hospital)
                return self.send_response(
                    description="Hospital is deleted successfuly",
                    success=True,
                    status_code=status.HTTP_200_OK,
                    code="200",
                )
            return self.send_response(
                code=f"422",
                status_code=status.HTTP_422_UNPROCESSABLE_ENTITY,
                description="Hospital doesn't found",
            )
        except Hospital.DoesNotExist:
            return self.send_response(
                code=f"422",
    ...
    def get(self, request, pk=None):
        try:
            ...
            return self.send_response(
                code="422",
                status_code=status.HTTP_422_UNPROCESSABLE_ENTITY,
                description="No Hcp_role matches the given query.",
            )
        except Hcp_role.DoesNotExist:
            return self.send_response(
                code="",
                status_code=status.HTTP_422_UNPROCESSABLE_ENTITY,
                description="Hcp_role doesn't exists",
            )
        except FieldError:
            return self.send_response(
                code=f"500",
        ...
        try:
            ...
            if serializer.is_valid():
                ...
                return self.send_response(
                    ...
                    code=f"201",
                    status_code=status.HTTP_201_CREATED,
                    description="Hcp_role is created",
                )
            return self.send_response(
                code=f"422",
                status_code=status.HTTP_422_UNPROCESSABLE_ENTITY,
        ...
        try:
            ...
            if serializer.is_valid():
                ...
                return self.send_response(
                    ...
                    code=f"201",
                    status_code=status.HTTP_201_CREATED,
                    description="Hcp role is updated",
                )
            return self.send_response(
                code=f"422",
                status_code=status.HTTP_422_UNPROCESSABLE_ENTITY,
            ...
            return self.send_response(
                code="422",
                status_code=status.HTTP_422_UNPROCESSABLE_ENTITY,
                description="No HCP ROLE matches the given query.",
            )
        except Hcp_role.DoesNotExist:
            return self.send_response(
                code=f"422",
                status_code=status.HTTP_422_UNPROCESSABLE_ENTITY,
                description="Hcp role doesn't exists",
            )
        except FieldError:
            return self.send_response(
                code=f"500",
    ...
    def get(self, request, pk=None):
        try:
            ...
            return self.send_response(
                code="422",
                status_code=status.HTTP_422_UNPROCESSABLE_ENTITY,
                description="No Languages matches the given query.",
            )
        except Languages.DoesNotExist:
            return self.send_response(
                code="",
                status_code=status.HTTP_422_UNPROCESSABLE_ENTITY,
                description="Languages doesn't exists",
            )
        except FieldError:
            return self.send_response(
                code=f"500",
        ...
        try:
            ...
            if serializer.is_valid():
                ...
                return self.send_response(
                    ...
                    code=f"201",
                    status_code=status.HTTP_201_CREATED,
                    description="Languages is created",
                )
            return self.send_response(
                code=f"422",
                status_code=status.HTTP_422_UNPROCESSABLE_ENTITY,
        ...
        try:
            ...
            if serializer.is_valid():
                ...
                return self.send_response(
                    ...
                    code=f"201",
                    status_code=status.HTTP_201_CREATED,
                    description=" Languages is updated",
                )
            return self.send_response(
                code=f"422",
                status_code=status.HTTP_422_UNPROCESSABLE_ENTITY,
    ...
    def get(self, request, pk=None):
        try:
            ...
            return self.send_response(
                code="422",
                status_code=status.HTTP_422_UNPROCESSABLE_ENTITY,
                description="No Audience matches the given query.",
            )
        except Audience.DoesNotExist:
            return self.send_response(
                code="",
                status_code=status.HTTP_422_UNPROCESSABLE_ENTITY,
                description="Audience doesn't exists",
            )
        except FieldError:
            return self.send_response(
                code=f"500",
        ...
        try:
            ...
            if serializer.is_valid():
                ...
                return self.send_response(
                    ...
                    code=f"201",
                    status_code=status.HTTP_201_CREATED,
                    description="Audience is created",
                )
            return self.send_response(
                code=f"422",
                status_code=status.HTTP_422_UNPROCESSABLE_ENTITY,
    ...
    def put(self, request, pk=None):
        try:
            ...
            serializer = AudienceSerializer(
                instance=saved_audience, data=data, partial=True
            )
            if serializer.is_valid():
                ...
                return self.send_response(
                    ...
                    code=f"201",
                    status_code=status.HTTP_201_CREATED,
                    description="Audience is updated",
                )
            return self.send_response(
                code=f"422",
                status_code=status.HTTP_422_UNPROCESSABLE_ENTITY,
...
class RegionView(BaseAPIView):
    ...
    def get(self, request, pk=None):
        try:
            ...
            return self.send_response(
                code="422",
                status_code=status.HTTP_422_UNPROCESSABLE_ENTITY,
                description="No Region matches the given query.",
            )
        except Region.DoesNotExist:
            return self.send_response(
                code="",
                status_code=status.HTTP_422_UNPROCESSABLE_ENTITY,
                description="Region doesn't exists",
            )
        except FieldError:
            return self.send_response(
                code=f"500",
    ...
    def put(self, request, pk=None):
        try:
            ...
            serializer = RegionSerializer(
                instance=saved_region, data=data, partial=True
            )
            if serializer.is_valid():
    ...
    def delete(self, request, pk=None):
        try:
            ...
            region.delete()
            return Response(
                {"message": "Proctor with id `{}` has been deleted.".format(pk)},
                status=204,
            )
        except ObjectDoesNotExist:
            return self.send_response(
    ...
    def get(self, request, pk=None):
        try:
            ...
            return self.send_response(
                code="422",
                status_code=status.HTTP_422_UNPROCESSABLE_ENTITY,
                description="No Solution matches the given query.",
            )
    ...
    def put(self, request, pk=None):
        try:
            ...
            serializer = SolutionSerializer(
                instance=saved_solution, data=data, partial=True
            )
            if serializer.is_valid():
    ...
    def get(self, request, pk=None):
        try:
            ...
            return self.send_response(
                code="422",
                status_code=status.HTTP_422_UNPROCESSABLE_ENTITY,
                description="No AreaOfExperties matches the given query.",
            )
        except AreaOfExperties.DoesNotExist:
            return self.send_response(
                code="",
                status_code=status.HTTP_422_UNPROCESSABLE_ENTITY,
                description="AreaOfExperties doesn't exists",
            )
        except FieldError:
            return self.send_response(
                code=f"500",
...
class HospitalViewSet(viewsets.ModelViewSet, BaseAPIView):
    ...
    def list(self, request, **kwargs):
        try:
            ...
            qualified_for_news_mics_program = request.query_params.get(
            ...
            if is_it_preceptorship != "":
                query_object &= Q(
                    is_it_preceptorship=IS_IT_PRECEPTORSHIP[is_it_preceptorship]
                )

            if qualified_for_news_mics_program != "":
                query_object &= Q(
                    qualified_for_news_mics_program=IS_IT_PRECEPTORSHIP[
                        qualified_for_news_mics_program
                    ]
                )
            ...
            return self.send_response(
                ...
                payload=result,
                code="",
                description="Proctors Data Table ",
                log_description="",
            )
        except Hospital.DoesNotExist:
            return self.send_response(
...
class COEView(BaseAPIView, CustomPagination):
    ...
    def get(self, request, pk=None):
        try:
            ...
            if qualified_for_news_mics_program:
                query_object &= Q(
                    qualified_for_news_mics_program=self.boolean(
                        qualified_for_news_mics_program
                    )
                )
...
class JustHospitalView(BaseAPIView, CustomPagination):
    ...
    def get(self, request, pk=None):
        try:
            ...
            code = request.query_params.get("code", "")
            deleted = request.query_params.get("deleted", "")
            is_it_preceptorship = boolean(
                request.query_params.get("is_it_preceptorship", "")
            )
            ...
            if qualified_for_news_mics_program:
                query_object &= Q(
                    qualified_for_news_mics_program=boolean(
                        qualified_for_news_mics_program
                    )
                )
            ...
            hospitals = hospitals.filter(query_object)
            hospitals = hospitals.filter(query_object).order_by(
                str(self.sorting_data(column_name, order))
            )

            serializer = HospitalViewSerializer(
                hospitals[offset : offset + limit], many=True
            )
            return self.send_response(
                success=True,
                status_code=status.HTTP_200_OK,
        ...
        try:
            ...
            if search_value:
                ...
                return self.send_response(
                    ...
                    payload={},
                    code="200",
                    description="Add Value for search",
                    log_description="",
                )
        except ObjectDoesNotExist:
            return self.send_response(
        ...
        try:
            ...
            if area_type == "local":
                ...
                hospitals = Hospital.objects.filter(
                    hospital_id__country__id__in=countries_id, is_it_preceptorship=True
                ).distinct()
            ...
            if country:
                hospitals = Hospital.objects.filter(
                    hospital_id__country__id=country
                ).distinct()
                serializer = HospitalNameSerializer(hospitals, many=True)
                return self.send_response(
                    success=True,
    ...
    def get(self, request, pk=None):
        try:
            ...
            if area_type == "local":
                ...
                countries_id = [country.countries.id for country in countries]
                hospitals = Hospital.objects.filter(
                    hospital_id__country__id__in=countries_id,
                    is_it_preceptorship=True,
            ...
            hospitals = Hospital.objects.filter(
                is_it_preceptorship=True, products__id=product
            ).distinct()
            serializer = HospitalNameSerializer(hospitals, many=True)
            return self.send_response(
                success=True,
