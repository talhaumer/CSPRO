    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(db_column='ApproachName', default='', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deleted_on', models.DateTimeField(auto_now=True, db_column='DeletedOn')),
                ('status', models.BigIntegerField(db_column='Status', default=0, help_text='Be default 0 which has no meaning this field is used for making the status like pending approved and for some other purpose')),
                ('name', models.CharField(db_column='AreaOfExpertiesName', default='', max_length=255)),
                ('code', models.SlugField(db_column='Code', default='')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deleted_on', models.DateTimeField(auto_now=True, db_column='DeletedOn')),
                ('status', models.BigIntegerField(db_column='Status', default=0, help_text='Be default 0 which has no meaning this field is used for making the status like pending approved and for some other purpose')),
                ('hospital_name', models.CharField(blank=True, db_column='HospitalName', max_length=255, null=True)),
                ('number_of_trainee', models.IntegerField(default=0)),
                ('location', models.CharField(db_column='Location', default='', max_length=255)),
                ('is_it_preceptorship', models.BooleanField(db_column='IsItPreceptorship', default=False)),
                ('qualified_for_news_mics_program', models.BooleanField(db_column='QualifiedForNewsMicsProgram', default=False)),
                ('cognos_id', models.CharField(blank=True, db_column='CognosID', default='', max_length=255, null=True)),
                ('code', models.SlugField(db_column='Code', default='', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deleted_on', models.DateTimeField(auto_now=True, db_column='DeletedOn')),
                ('status', models.BigIntegerField(db_column='Status', default=0, help_text='Be default 0 which has no meaning this field is used for making the status like pending approved and for some other purpose')),
                ('country', models.ForeignKey(blank=True, db_column='HospitalCountry', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='hospital_country', to='zone.countries')),
                ('hospital', models.ForeignKey(blank=True, db_column='HospitalId', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='hospital_id', to='api.hospital')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='hospital',
            name='products',
            field=models.ManyToManyField(blank=True, db_column='HospitalProducts', related_name='hospitals_products', to='api.Products'),
        ),
    ]
