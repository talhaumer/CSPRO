    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deleted_on', models.DateTimeField(auto_now=True, db_column='DeletedOn')),
                ('status', models.BigIntegerField(db_column='Status', default=0, help_text='Be default 0 which has no meaning this field is used for making the status like pending approved and for some other purpose')),
                ('name', models.CharField(db_column='ZoneName', default=None, max_length=255, unique=True)),
                ('code', models.SlugField(db_column='Code', default='')),
            ],
            options={
                'db_table': 'Zone',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('countries', models.ForeignKey(blank=True, db_column='CountriesID', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='zone_countires', to='zone.countries')),
                ('zone', models.ForeignKey(blank=True, db_column='ZoneID', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='zone_zone_countires', to='zone.zone')),
            ],
            options={
