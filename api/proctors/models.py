...
from api.models import Approach, AreaOfExperties, Hospital, Languages, Products
...
class Proctors(Base):
    ...
    area_of_experties = models.ManyToManyField(
        AreaOfExperties,
    ...
    approach = models.ManyToManyField(
        Approach, db_column="ProctorsApproachID", related_name="proctors_approach"
    )
    publication = models.TextField(db_column="Publications")
    products = models.ManyToManyField(
        Products, related_name="proctors_products", db_column="ProctorsProductsID"
    )
    ...
    proctorShip_contract_start_details = models.DateField(
        db_column="ProctorShipContractStartingDetails", null=True, blank=True
    )
    proctorShip_contract_ending_details = models.DateField(
        db_column="ProctorShipContractEndingDetails", null=True, blank=True
    )
    unavailability_start_date = models.DateField(
        db_column="UnavailabilityStartDate", null=True, blank=True
    )
    unavailability_end_date = models.DateField(
        db_column="UnavailabilityEndDate", null=True, blank=True
    )
    ...
    is_masterproctorship = models.BooleanField(
        default=False, db_column="IsMasterProctorShip"
    )
