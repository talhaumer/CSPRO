...
def add_focus():
    try:
        types = [
            "Speaking at corcym webinar (HCP virtual meetings)",
            "Speaking at corcym webinar (HCP Peer-to-Peer event)",
            "Speaking / Training at corcym event (Patient education program)",
            "Speaking / Training at third party event (HCP education)",
            "Speaking / Training at third party event (Patient education)",
            "Speaking/Training at  Corcym Event-Symposium (At third party)",
        ]
        for each in types:
