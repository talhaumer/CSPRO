...
def add_data():
    try:
        data = [
            "The number of patients implanted is equal then number of patients selected",
            "The patient was not operated at all",
            "Perceval could not be used-Upredicted bicuspid valve type 0",
            "Annulus too small",
            "Annulus too large",
            "Other",
        ]
